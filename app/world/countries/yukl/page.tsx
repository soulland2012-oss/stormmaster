...
import { yuklData as d } from '@/data/countries/yukl'
...
export const metadata: Metadata = {
  title: 'ЮКЛ — Stormmaster Archive',
  description: 'Южная Колония Людей — отдалённое владение на третьем материке, управляемое временным советом наместников.',
}

export default function YuklPage() {
  return (
    <article>
      <ArticleHero
        title={d.title}
        ...
        tags={['НЕЗАВИСИМОЕ ГОСУДАРСТВО', 'КОЛОНИЯ', 'ТРЕТИЙ МАТЕРИК']}
      />
