...
import { yotunheimData as d } from '@/data/countries/yotunheim'
...
export const metadata: Metadata = {
  title: 'Йотунхейм — Stormmaster Archive',
  description: 'Земля йотнаров, потомков великанов — три Круга кланов, автономных в составе Империи Фенридия, управляемых Советом Трёх Кругов.',
}

export default function YotunheimPage() {
  return (
    <article>
      <ArticleHero
        title={d.title}
        ...
        tags={['ФЕДЕРАЦИЯ ФЕНРИДИЯ', 'АВТОНОМИЯ', 'ЙОТНАРЫ']}
      />
