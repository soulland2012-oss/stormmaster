...
import { grafstvoKroviData as d } from '@/data/countries/grafstvo-krovi'
...
export const metadata: Metadata = {
  title: 'Графство Крови — Stormmaster Archive',
  description: 'Вампирская Диархия Домов Найтвинг и Малькевир, где статус определяет процент чистой крови прародителя, а гема-реакторы питают Багровые Экспрессы.',
}

export default function GrafstvoKroviPage() {
  return (
    <article>
      <ArticleHero
        title={d.title}
        ...
        tags={['ФЕДЕРАЦИЯ ФЕНРИДИЯ', 'ДИАРХИЯ', 'ВАМПИРЫ']}
      />
