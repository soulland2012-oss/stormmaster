...
import { grasiyaData as d } from '@/data/countries/grasiya'
...
export const metadata: Metadata = {
  title: 'Грасия — Stormmaster Archive',
  description: 'Раздробленное коррумпированное королевство под тенью Синдиката Крестов — слабый король, одиннадцать дворянских домов и постоянные феодальные войны.',
}

export default function GrasiyaPage() {
  return (
    <article>
      <ArticleHero
        title={d.title}
        ...
        tags={['ФЕДЕРАЦИЯ ФЕНРИДИЯ', 'СЛАБАЯ МОНАРХИЯ', 'КОРРУПЦИЯ']}
      />
