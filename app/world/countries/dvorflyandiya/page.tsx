...
import { dvorflyandiyaData as d } from '@/data/countries/dvorflyandiya'
...
export const metadata: Metadata = {
  title: 'Дворфляндия — Stormmaster Archive',
  description: 'Древняя технологическая держава дворфов под горами Новой Терры — Стальной легион големов и стимпанк с рунной магией.',
}

export default function DvorflyandiyaPage() {
  return (
    <article>
      <ArticleHero
        title={d.title}
        ...
        tags={['НЕЗАВИСИМОЕ ГОСУДАРСТВО', 'ЦАРСТВО', 'ДВОРФЫ']}
      />
