...
import { tikhiyKhorData } from '@/data/tikhiy-khor'
...
import TikhiyKhorBody from '@/components/lore/TikhiyKhorBody'

export const metadata: Metadata = {
  title: 'Тихий Хор — Stormmaster Archive',
  description: 'Нигилистический культ Залмира, Бога Тьмы и Истинного Конца. Добровольные палачи энтропии, чья цель — ускорить возвращение мира к Пустоте.',
}

const ACCENT = '#6E7A8A'

export default function TikhiyKhorPage() {
  const d = tikhiyKhorData
